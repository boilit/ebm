 ...
 * @see
 */
public final class WebitScript_NoASM extends AbstractEngine {
    ...
    public final void init(Properties properties) throws Exception {
        ...
        parameters.put("webit.script.Engine.enableAsmNative", "false");
        parameters.put("webit.script.resolvers.ResolverManager.enableAsm", "false");
