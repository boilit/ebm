...
public final class JdkStringBuilder extends AbstractEngine {
    ...
    public final void work(final Map<String, Object> model, final Writer writer) throws Exception {
        ...
        final StringBuilder builder = new StringBuilder(900 + 600 * items.size());
        builder
                .append("<!DOCTYPE html>\n")
                .append("<html>\n")
                .append("<head>\n")
                .append("    <title>StockModel - JdkStringBuilder</title>\n")
                ...
                .append("            background-color: #C8FBAF;\n")
                .append("        }\n")
                .append("\n")
                .append("        .odd {\n")
                .append("            background-color: #F3DEFB;\n")
                .append("        }\n")
                .append("\n")
                .append("        .even {\n")
                .append("            background-color: #EFFFF8;\n")
                .append("        }\n")
                .append("    </style>\n")
                .append("</head>\n")
                .append("<body>\n")
                .append("<h1>StockModel - Bsl</h1>\n")
                .append("<table>\n")
                .append("    <thead>\n")
                .append("    <tr>\n")
                .append("        <th>#</th>\n")
        ...
        for (int i = 0; i < size; i++) {
            item = items.get(i);
            builder
                    .append("    <tr class=\"").append(i % 2 == 0 ? "odd" : "even").append("\">\n")
                    .append("        <td>").append(i).append("</td>\n")
                    .append("        <td>").append(item.getId()).append("</td>\n")
                    .append("        <td>").append(item.getCode()).append("</td>\n")
                    .append("        <td style=\"text-align: left;\">").append(item.getName()).append("</td>\n")
                    .append("        <td>").append(item.getPrice()).append("</td>\n")
                    .append("        <td style=\"color: ").append(item.getRange() >= 10 ? "red" : "blue").append(";\">${item.range}%</td>\n")
